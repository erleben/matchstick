#ifndef PROX_MOREAU_TIME_STEPPER_H
#define PROX_MOREAU_TIME_STEPPER_H
...
namespace prox
{
                                  ...
                                  )
  {
    ...
    //typedef typename M::vector3_type               V3;
    ...
    //typedef typename M::block6x1_type       B6x1;
    ...
    V7        qM;     // position half step update
