#ifndef TINY_POLAR_DECOMPOSITION_H
#define TINY_POLAR_DECOMPOSITION_H

#include <tiny_vector.h>     // for Vector
...
{  
      ...
      */
      ...
      inline bool polar_decomposition_eigen(matrix3x3_type const & A,matrix3x3_type & R,matrix3x3_type & S)
      {
        using std::sqrt;
        ...
        typedef          Vector<3, typename matrix3x3_type::type_traits>   vector3_type;
        ...
        vector3_type v1 = vector3_type::make( V(0,1), V(1,1), V(2,1) );
        vector3_type v2 = vector3_type::make( V(0,2), V(1,2), V(2,2) );
